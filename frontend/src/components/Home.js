    ...
    <div className="scrollable-component " >
      <div className="home-container">
        ...
        <div className="mt-5 bg-light">
          <p className="mt-5 fw-bold text-center fs-1 text-decoration-underline">
            Our Mission
          </p>
          <div className="row" style={{ width: "90vw", margin: "auto" }}>
            <div className="col" style={{}}>
              <h1 className="welcome-title" style={{ fontWeight: "bold" }}>Welcome to Lyft Culture!</h1>
              <p style={{ fontSize: "20px" }}>
                ...
                providing a user-friendly experience and expert guidance. Simply
                select your year and engineering department, then explore
                organized subjects by semester. Easily access question papers
                and relevant notes to prepare effectively. Got questions or
                feedback? Additionally, gain insights into interview experiences
                from our college and engage in discussions to get all the
                answers you need.
              </p>
              <p
                className="fw-semibold text-black-38"
                style={{ fontSize: "20px" }}
              >
                Reach out to our supportive team anytime. Thank you for choosing
                ExamEase as your study companion. Let's unlock your academic
