      ...
      <div className="home-container">
        <div className="home-header">
          <div className="content">
            ...
            <p
              ...
              style={{ color: "white", height: "30px", fontSize: "25px" }}
            >
              <i>
                Embark on your academic journey with confidence as you access
                our valuable resources. Let's elevate your learning experience
                together!
              </i>
            </p>
          </div>
                  ...
                  >
                    ...
                    >
                      <div className="card-body">
                        {isHovered2 && (
                          <div className="text-overlay">
                            <p className="overlay-text fs-3 fw-bold">
                              Upload Notes
                            </p>
                          </div>
                        )}
        ...
        <div className="bg-light">
          <div className="row">
            <div className="col-md-3">
              <p
                className=" text-left fs-3 my-3 fw-bold border-end border-dark hide-on-mobile"
            ...
            <div
              class="col-md-3 text-center my-3 d-flex offset-md-3 "
            ...
            >
              ...
              >
                <i
                  ...
                  style={{ fontSize: "25px", color: "#125D98" }}
                ></i>
              </a>
              ...
              <a href="" target="_blank" style={{ marginRight: "10px" }}>
                <i
                  ...
                  style={{ fontSize: "25px", color: "magenta" }}
                ></i>
              </a>
              <a href="" target="_blank" style={{ marginRight: "10px" }}>
                <i
